...
{
	private static final Set<Block> heads = ImmutableSet.of(ModBlocks.BLAZE_HEAD.get(), ModBlocks.ENDERMAN_HEAD.get(), ModBlocks.SPIDER_HEAD.get(), ModBlocks.CAVE_SPIDER_HEAD.get(),
